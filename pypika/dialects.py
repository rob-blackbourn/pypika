...
class MySQLLoadQueryBuilder:
    ...
    def into(self, table: Union[str, Table]) -> "MySQLQueryBuilder":
        with copy_if_immutable(self) as this:
            this._into_table = table if isinstance(table, Table) else Table(table)
            return this
...
class VerticaCopyQueryBuilder:
    ...
    def copy_(self, table: Union[str, Table]) -> "VerticaCopyQueryBuilder":
        with copy_if_immutable(self) as this:
            this._copy_table = table if isinstance(table, Table) else Table(table)
            return this
...
class PostgreQueryBuilder(QueryBuilder):
        ...
        with copy_if_immutable(self) as this:
            ...
            for target_field in target_fields:
                if isinstance(target_field, str):
                    this._on_conflict_fields.append(this._conflict_field_str(target_field))
    ...
    def do_update(self, update_field: Union[str, Field], update_value: Any) -> "PostgreQueryBuilder":
        with copy_if_immutable(self) as this:
            ...
            this._on_conflict_do_updates.append((field, ValueWrapper(update_value)))
            return this
        ...
        with copy_if_immutable(self) as this:
            for term in terms:
                if isinstance(term, Field):
                    ...
                    this._return_other(this.wrap_constant(term, this._wrapper_cls))
            return this
